...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "relative inline-flex items-center px-6 py-3 rounded-xl font-bold transition-all duration-300 active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none overflow-hidden group font-geist  cursor-pointer";
    ...
    >
      ...
      {withArrow && (
        ...
        >
          ...
          <span className="relative z-10 inline-flex h-4 w-4 items-center justify-center overflow-hidden cta-arrow-idle">
            <ArrowRight
              className="absolute h-4 w-4 transition duration-300 group-hover:translate-x-5 group-hover:opacity-0"
              strokeWidth={2.4}
            />
            <ArrowRight
              className="absolute h-4 w-4 -translate-x-5 opacity-0 transition duration-300 group-hover:translate-x-0 group-hover:opacity-100"
              strokeWidth={2.4}
            />
          </span>
        </span>
