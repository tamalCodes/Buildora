...
import type { AuthFieldErrorKey, AuthFieldErrors } from "../constants/types";
        ...
        {step === AuthStep.IDENTIFY ? (
          <div className="space-y-6 sm:space-y-8">
            ...
            <form onSubmit={handleIdentify} className="space-y-5 sm:space-y-6">
              ...
              />
              <Button
                className="w-full py-3.5 text-base bg-indigo-600 hover:bg-indigo-500 hover:shadow-none border-indigo-400/20"
                isLoading={isLoading}
              >
                Continue
              </Button>
