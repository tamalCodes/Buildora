...
const HackathonsSponsorCtaSection: React.FC = () => (
  <section className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-surface)] p-8">
    <div className="flex flex-col items-start justify-between gap-5 lg:flex-row lg:items-center">
      <div>
        <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-[var(--accent-text-soft)]">
          Buildora for teams
        </p>
        <h3 className="mt-2 text-2xl font-geist font-black text-[var(--text-heading)]">
